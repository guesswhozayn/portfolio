...
export default function ResumePage() {
  return (
    <motion.div
      ...
      className="min-h-screen bg-zinc-50 text-zinc-900 pt-36 pb-20 px-4 md:px-8"
    >
      <div className="mx-auto max-w-[800px] space-y-16">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-xl bg-zinc-900 text-white hover:scale-[1.02] active:scale-[0.98] transition-all shadow-sm"
          >
            <FiDownload size={16} />
            Download
          </a>
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xl text-indigo-500 font-medium">Software Engineer</p>
          </div>
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a href="https://linkedin.com/in/z4yn" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-zinc-200 hover:border-zinc-300 transition-colors text-sm font-medium shadow-sm">
              <FiLinkedin className="text-[#0A66C2]" /> LinkedIn
            </a>
            <a href="https://github.com/guesswhozayn" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-zinc-200 hover:border-zinc-300 transition-colors text-sm font-medium shadow-sm">
              <FiGithub /> GitHub
            </a>
            <a href="https://z4yn.vercel.app" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-zinc-200 hover:border-zinc-300 transition-colors text-sm font-medium shadow-sm">
              <FiGlobe className="text-emerald-500" /> Portfolio
            </a>
          </div>

          <p className="text-base leading-relaxed text-zinc-600 mt-6 bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
        ...
        <section className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-zinc-300 transition-colors">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-5">
              <div>
                <h3 className="text-lg font-bold text-zinc-900">Freelance Software Engineer</h3>
                <p className="text-indigo-500 text-sm font-medium mt-1">Upwork | Remote</p>
              </div>
              <span className="text-xs font-semibold tracking-wider text-zinc-500 font-mono bg-zinc-100 px-3 py-1.5 rounded-lg self-start sm:self-auto">
                May 2024 – Present
              </span>
            </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            {projects.map((project, idx) => (
              <div key={idx} className="p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-zinc-300 transition-colors">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-5">
                  <div>
                    <h3 className="text-lg font-bold text-zinc-900">{project.name.split(':')[0]}</h3>
                    <p className="text-indigo-500 text-sm font-medium mt-1">{project.name.split(':')[1]?.trim()}</p>
                  </div>
                  <div className="flex flex-col sm:items-end gap-3">
                    ...
                    <div className="flex gap-2">
                      <a href={project.live} target="_blank" rel="noreferrer" className="p-2 rounded-lg bg-zinc-50 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 transition-colors" title="Live">
                        <FiExternalLink size={16} />
                      </a>
                      <a href={project.link} target="_blank" rel="noreferrer" className="p-2 rounded-lg bg-zinc-50 text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 transition-colors" title="GitHub">
                        <FiGithub size={16} />
                      </a>
                    </div>
                  </div>
                ...
                <ul className="space-y-3">
                  {project.bullets.map((bullet, bIdx) => (
                    <li key={bIdx} className="flex gap-3 text-sm text-zinc-600 leading-relaxed">
                      <span className="text-zinc-300 mt-1">•</span>
                      <span>{bullet}</span>
                    </li>
                  ))}
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {skillCategories.map((category, idx) => (
              <div key={idx} className="p-5 rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-zinc-300 transition-colors">
                <h3 className="text-sm font-bold tracking-wide text-zinc-900 mb-4 flex items-center gap-2">
                  {category.icon} {category.title}
                </h3>
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, sIdx) => (
                    <span key={sIdx} className="text-xs font-semibold px-2.5 py-1.5 rounded-lg bg-zinc-50 text-zinc-700 border border-zinc-200/60">
                      {skill}
                    </span>
                  ))}
                </div>
        ...
        <section className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white border border-zinc-200 shadow-sm hover:border-zinc-300 transition-colors">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-5">
              <div>
                <h3 className="text-lg font-bold text-zinc-900">Bachelor of Science in Computer Science</h3>
                <p className="text-indigo-500 text-sm font-medium mt-1">The University of Chakwal</p>
              </div>
              <span className="text-xs font-semibold tracking-wider text-zinc-500 font-mono bg-zinc-100 px-3 py-1.5 rounded-lg self-start sm:self-auto">
                Sep 2022 – Jun 2026
              </span>
            ...
            <div className="space-y-3 text-sm text-zinc-600">
              <p><span className="font-semibold text-zinc-900">CGPA:</span> 3.41 / 4.00</p>
              <p className="leading-relaxed"><span className="font-semibold text-zinc-900">Relevant Coursework:</span> Data Structures & Algorithms, Object-Oriented Programming, Database Management Systems, Web Engineering, Operating Systems, Software Engineering, Artificial Intelligence</p>
            </div>
          </div>
        </section>
